<nav class="navbar navbar-expand-lg navbar-dark bg-info fixed-top">
  <div class="container">
    <a style="font-size: 30px" class="page-scroll oleo-font navbar-brand" href="#home">Anna Laundry</a>
...
<section class="pt-5">
  <div class="jumbotron jumbotron-fluid bg-info">
    <div class="container text-white text-center">
      ...
      <h1 class="text-shadow display-4 oleo-font font-weight-bold">Anna Laundry</h1>

      <h4 class="text-shadow my-3">Bingung mikirin <span class="font-weight-bold">CLBK</span> Cucian Lama <span class="font-weight-bold">Belum Kering</span></h4>
      <h5 class="text-shadow my-2">Bawa Aja Ke <span class="font-weight-bold"> Anna Laundry </span>, Mudah <span class="font-weight-bold"> Cepat </span> dan <span class="font-weight-bold oleo-font">Tentunya Berkualitas</span></h5>
...
<footer class="bg-dark text-white p-4">
	<div class="container-fluid">
        ...
        <div class="row text-left my-2">
          ...
          <div class="col-lg-8"> Dukuh Sidorejo, Desa Sajen,  Kecamatan Trucuk Kabupaten Klaten Provinsi Jawa Tengah</div>
        </div>
      </div>
	  <div class="col-lg-6 my-3">
		    	<h3 class="oleo-font">Anna Laundry</h3>
		    	<div class="row">
		    		<div class="col-lg">
		...
		<div class="row">
			<div class="col-lg">
				<iframe class="rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.781660947668!2d110.64181047366286!3d-7.706563476333559!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a4797f16cdcf7%3A0x4c30d5a4b84ed2d!2sDukuh%20Panasan!5e0!3m2!1sid!2sid!4v1717745969995!5m2!1sid!2sid" height="300" frameborder="0" style="border:0; margin-top: 15px;width: 100%" allowfullscreen=""></iframe>
			</div>
		</div>
	</div>
</footer>
